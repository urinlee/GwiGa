...
export const Default: Story = {
    args: {
        ...
        assignedActives: allActives.slice(0, 3),
    },
};
...
export const AddActiveTogglesIcon: Story = {
    args: {
        ...
        assignedActives: allActives.slice(0, 2),
    },
    play: async ({ canvasElement }) => {
        // 모달 열기: 하단 트리거(+)는 canvas 안의 유일한 circle-plus
        const trigger = canvasElement.querySelector<SVGElement>(".lucide-circle-plus");
        ...
        const rowOf = (name: string) =>
            modal.getByText(name).closest("div.justify-between") as HTMLElement;
...
export const ManyAssignedActives: Story = {
    args: {
        groupAllActives: allActives,
        assignedActives: Array.from({ length: 12 }, (_, index) =>
