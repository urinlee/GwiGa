...
export const dashboardStatusClasses:ObjectStatusWithCalsses = {
...
export type dashboardStatusTypes = keyof typeof dashboardStatusClasses;

export const participateStatusClasses:ObjectStatusWithCalsses = {
...
export type participateContentStatus = keyof typeof participateStatusClasses;